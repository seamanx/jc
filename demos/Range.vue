  ...
  <div>
    ...
    <group title="Step">
      <cell title="step=10" :inline-desc="'valus is: '+data7" primary="content">
        <range :value.sync="data7" :min="7" :max="77" :step="10"></range>
      </cell>
    </group>

    <group title="disabled">
      <cell title="disabled=true" :inline-desc="'valus is: '+data8" primary="content">
        <range :value.sync="data8" disabled></range>
      </cell>
      <cell title="Opacity" :inline-desc="'valus is: '+data8" primary="content">
        <range :value.sync="data8" disabled :disabled-opacity="0.1"></range>
      </cell>
    </group>

    <group title="bar height">
      <cell title="Line width" :inline-desc="'value is: '+data9" primary="content">
        <range :value.sync="data9" :range-bar-height="4"></range>
      </cell>
    </group>

    <group title="custom min and max html">
      <cell title="文字大小" :inline-desc="'font size: ' + data10" primary="content">
        <range :value.sync="data10" :min="12" :max="22" min-HTML="<span style='font-size:12px;'>小</span>" max-HTML="<span style='font-size:22px;'>大</span>"></range>
      </cell>
      <cell title="bcontentness" :inline-desc="'value is: ' + data11 + '%'" primary="content">
        <range :value.sync="data11" min-HTML="<span style='font-size:16px;color:#F90;'>☼</span>" max-HTML="<span style='font-size:30px;color:#F90;'>☼</span>"></range>
      </cell>
    </group>

    <group title="two way binding">
      <cell title="Default" primary="content">
        <range :value.sync="data12"></range>
      </cell>
      <cell title="Default" primary="content">
        <range :value.sync="data12"></range>
      </cell>
    ...
    <group :title="'use v-show ' + 'data: ' + data13">
      <cell title="Default" primary="content">
        <range :step="10" :value.sync="data13" v-show="showData13"></range>
      </cell>
    </group>
...
<script>
import { XButton, Range, Group, GroupTitle, Cell } from '../components-vux'
